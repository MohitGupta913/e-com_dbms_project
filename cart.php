		...
		while($p_price=mysqli_fetch_array($run_price)){
			...
			$total += $values; 
				...
				<tr>
					...
					<tr align="center">
						<td colspan="2"> <input class="btn btn-warning" type="submit" value="Update Cart" name="update_cart"></td>
						<td> <input class="btn btn-warning" type="submit" value="Continue Shopping" name="continue"></td>
